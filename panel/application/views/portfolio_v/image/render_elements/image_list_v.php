                                    ...
                                    <tbody id="sortable" class="sortable text-center" data-url="<?php echo base_url("portfolio/imageRankSetter"); ?>" style="vertical-align: baseline;">
                                        ...
                                        <?php foreach($item_images as $items){ ?>
                                            <tr id="ord-<?php echo $items->id; ?>">
                                                ...
                                                <td>
                                                    <img class="img-fluid rounded-3" src="<?php echo base_url("uploads/portfolio_v/$items->imgUrl"); ?>" width="120px" alt="category">
                                                </td>
                                                <td>
                                                    <div class="form-check form-switch d-flex justify-content-center">
                                                        <input 
                                                            data-url="<?php echo base_url("portfolio/isCoverSetter/$items->id/$items->portfolioID"); ?>"
                                                ...
                                                <td>
                                                    <div class="form-check form-switch d-flex justify-content-center">
                                                        <input 
                                                            data-url="<?php echo base_url("portfolio/imageIsActiveSetter/$items->id"); ?>"
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <a class="remove-btn" data-url="<?php echo base_url("portfolio/imageDelete/$items->id/$items->portfolioID"); ?>">
