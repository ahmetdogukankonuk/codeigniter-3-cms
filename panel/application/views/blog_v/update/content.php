        <div class="px-4 page-title title-color">
            <h3> <?php echo $this->lang->line('update-post'); ?> </h3>
        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="text" id="text" cols="30" rows="10" placeholder="<?php echo $this->lang->line('text'); ?> (<?php echo $this->lang->line('english'); ?>)"><?php echo $item->text; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="text_tr" class="form-label text-color"><?php echo $this->lang->line('text'); ?> (<?php echo $this->lang->line('turkish'); ?>)</label>
                                                <textarea class="form-control" name="text_tr" id="text_tr" cols="30" rows="10" placeholder="<?php echo $this->lang->line('text'); ?> (<?php echo $this->lang->line('turkish'); ?>)"><?php echo $item->text_tr; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
